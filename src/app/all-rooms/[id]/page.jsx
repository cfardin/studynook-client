            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mt-6">
                        <h1 className="text-3xl md:text-4xl font-serif font-bold text-gray-900">{title}</h1>
                        <span className="flex items-center gap-1 bg-green-50 text-green-700 text-sm font-semibold px-3 py-1 rounded-full w-fit">
